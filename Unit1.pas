...
function set_Memo(i:integer;cmp:TMemo):boolean;
begin
  with form1 do begin
...
begin
  form1.TrackBar1.Position := updown1.Position;
end;

procedure TForm1.UpDown2Changing(Sender: TObject;
  var AllowChange: Boolean);
begin
  form1.TrackBar2.Position := updown2.Position;
end;

procedure TForm1.UpDown3Changing(Sender: TObject;
  var AllowChange: Boolean);
begin
  form1.TrackBar3.Position := updown3.Position;
end;

procedure TForm1.UpDown4Changing(Sender: TObject;
  var AllowChange: Boolean);
begin
  form1.TrackBar4.Position := updown4.Position;
end;

procedure TForm1.TrackBar1Change(Sender: TObject);
begin
  updown1.Position := form1.TrackBar1.Position;
end;

procedure TForm1.TrackBar2Change(Sender: TObject);
begin
  updown2.Position := form1.TrackBar2.Position;
  combobox3.Text := inttostr(form1.TrackBar2.Position);
end;

procedure TForm1.TrackBar3Change(Sender: TObject);
begin
  updown3.Position := form1.TrackBar3.Position;
end;

procedure TForm1.TrackBar4Change(Sender: TObject);
begin
  updown4.Position := form1.TrackBar4.Position;
end;

procedure TForm1.ComboBox2Change(Sender: TObject);
begin
  try
    form1.TrackBar1.Position := strtoint(combobox2.text);
  except
  end;
end;
...
begin
  try
    form1.TrackBar2.Position := strtoint(combobox3.text);
  except
  end;
end;
...
begin
  try
    form1.TrackBar3.Position := strtoint(combobox4.text);
  except
  end;
end;
...
begin
  try
    form1.TrackBar4.Position := strtoint(combobox5.text);
  except
  end;
end;
...
begin
  try
    set_Memo(combobox6.itemIndex,memo1);
  except
