...
begin
  begin
    //Žw’èƒfƒBƒŒƒNƒgƒŠ‚Ì‚·‚×‚Ä‚ÌŽí—Þ‚Ìƒtƒ@ƒCƒ‹‚ð—ñ‹“
...
//      showmessage(s1);
      ...
      if cmpname = 'ŽÊ^' then begin
        ...
        B.Free;
        J.Free;
      end else if cmpname = 'ƒƒ‚' then begin
        if st.Count > 0 then begin
          try
            //if st[0] = null then
...
begin
  if form1.ListBox1.Items.Count = 0 then begin
    CreateDir( ExtractFilePath( Paramstr(0) ) + '–¼ŽhƒTƒ“ƒvƒ‹');
    st := TStringList.Create;
    st.Text :=
    '2' + chr(13)
    + '0;‚l‚r ‚oƒSƒVƒbƒN;9' + chr(13)
    + '20' + chr(13)
    + '68' + chr(13)
    + '36' + chr(13)
    + '261' + chr(13)
    + '2' + chr(13)
    + '0;‚l‚r ‚oƒSƒVƒbƒN;14' + chr(13)
    + '63' + chr(13)
    + '68' + chr(13)
    + '36' + chr(13)
    + '261' + chr(13)
    + '2' + chr(13)
    + '0;‚l‚r ‚oƒSƒVƒbƒN;10' + chr(13)
    + '108' + chr(13)
    + '9' + chr(13)
    + '94' + chr(13)
    + '321' + chr(13)
    ...
    + '62' + chr(13)
    + '53' + chr(13);
    st.SaveToFile(ExtractFilePath( Paramstr(0) ) + '–¼ŽhƒTƒ“ƒvƒ‹' + '\Meisi.mpr');
    st.Free;
    {form1.setprjdir := ExtractFilePath( Paramstr(0) ) + '–¼ŽhƒTƒ“ƒvƒ‹' + '\';
    loadseting(ExtractFilePath( Paramstr(0) ) + '–¼ŽhƒTƒ“ƒvƒ‹' + '\Meisi.mpr');}
...
begin
  if 0 < ansipos('ŽÊ^',combobox6.Text) then begin
    try
  ...
  end else if 0 < ansipos('ƒƒ‚',combobox6.Text) then begin
    try
