...
function create_pic(i:integer;img:TImage;loadPIC:boolean):boolean;
var
  J:TJPegImage;
  B:TBitmap;
begin
...
begin
  if s = '写真' then begin
    ...
    create_pic(form1.comp.Count -1,TImage.Create(form1),true);
...
begin
  try
    create_pic(form1.ComboBox6.ItemIndex,TImage.Create(form1),true);
  except
...
begin
  if 0 < ansipos('メモ',combobox6.Text) then begin
    ...
    try
      create_PIC(combobox6.ItemIndex,Image1,false);
    except end;
  end;
